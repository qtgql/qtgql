...
class AppleModel(BaseModel):
    def __init__(self, data: list[Apple], parent: BaseGraphQLObject | None = None):
        super().__init__(data, parent)
...
class WormModel(BaseModel):
    def __init__(self, data: list[Worm], parent: BaseGraphQLObject | None = None):
        super().__init__(data, parent)
...
class MutationModel(BaseModel):
    def __init__(self, data: list[Mutation], parent: BaseGraphQLObject | None = None):
        super().__init__(data, parent)
...
class SubscriptionModel(BaseModel):
    def __init__(self, data: list[Subscription], parent: BaseGraphQLObject | None = None):
        super().__init__(data, parent)
