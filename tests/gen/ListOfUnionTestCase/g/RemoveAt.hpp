...
class QTGQL_EXPORT_FOR_UNIT_TESTS Dog__removeAtpets
...
protected:
  std::shared_ptr<ListOfUnionTestCase::Dog> m_inst;
...
class QTGQL_EXPORT_FOR_UNIT_TESTS Cat__removeAtpets
    : public qtgql::bases::ObjectTypeABC {
...
protected:
  std::shared_ptr<ListOfUnionTestCase::Cat> m_inst;
...
class QTGQL_EXPORT_FOR_UNIT_TESTS Person__removeAt
  ...
  Q_PROPERTY(const QString &name READ get_name NOTIFY nameChanged);
  Q_PROPERTY(const qtgql::bases::ListModelABC<qtgql::bases::ObjectTypeABC *>
                 *pets READ get_pets NOTIFY petsChanged);
  Q_PROPERTY(const qtgql::bases::scalars::Id &id READ get_id NOTIFY idChanged);
...
protected:
  std::shared_ptr<ListOfUnionTestCase::Person> m_inst;
  qtgql::bases::ListModelABC<qtgql::bases::ObjectTypeABC *> *m_pets;
...
public:
  [[nodiscard]] const QString &get_name() const;
  [[nodiscard]] const qtgql::bases::ListModelABC<
      qtgql::bases::ObjectTypeABC *> *
  get_pets() const;
  [[nodiscard]] const qtgql::bases::scalars::Id &get_id() const;
...
protected:
  std::shared_ptr<ListOfUnionTestCase::Mutation> m_inst;
...
class QTGQL_EXPORT_FOR_UNIT_TESTS RemoveAt
  ...
  inline const QString &ENV_NAME() final {
    static const auto ret = QString("ListOfUnionTestCase");
    return ret;
  }
signals:
  void dataChanged();
